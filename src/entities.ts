import { CRUD_OPERATIONS, EntityRoute, Groups, Subresource } from "@astahmer/entity-routes";
import { PrimaryGeneratedColumn, Entity, Column, OneToMany, ManyToOne, ManyToMany } from "typeorm";

export const getEntities = () => [Image, Role, User, Article, Comment, Upvote];
